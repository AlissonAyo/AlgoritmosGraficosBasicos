...
namespace Ayo_Alisson_Algoritmos
{
    ...
    {
        private static FrmScanlineFill _instance;
        Graphics g;
        ...
        public static FrmScanlineFill Instance
        {
            get
            {
                if (_instance == null || _instance.IsDisposed)
                {
                    _instance = new FrmScanlineFill();
                }
                return _instance;
            }
        }
        ...
        public FrmScanlineFill()
        {
            ...
            this.FormClosing += FrmScanlineFill_FormClosing;
        }

        private void FrmScanlineFill_FormClosing(object sender, FormClosingEventArgs e)
        {
            LiberarRecursos();
        }
        ...
        private void btnCalcular_Click(object sender, EventArgs e)
        {
            ...
            if (figuraRecortada != null && figuraRecortada.Count >= 3)
            {
                ...
                MessageBox.Show($"Polígono recortado con Scanline!\n\n" +
        ...
        private void FrmScanlineFill_Load(object sender, EventArgs e)
        {
            this.Text = "Algoritmo Scanline Fill - Relleno por Barrido con Recorte";
            DibujarRectanguloRecorte();
        }

        private void FrmScanlineFill_Paint(object sender, PaintEventArgs e)
        {
            RedibujarTodo();
        }
    }
