...
namespace Ayo_Alisson_Algoritmos
{
    ...
    {
        private static FrmCohenSutherland _instance;
        private AlgoritmoCohenSutherland algoritmo = new AlgoritmoCohenSutherland();
        ...
        public static FrmCohenSutherland Instance
        {
            get
            {
                ...
                {
                    _instance = new FrmCohenSutherland();
                }
                return _instance;
            }
        }
        ...
        private void btnCalcular_Click(object sender, EventArgs e)
        {
            ...
            foreach (var linea in lineasDibujadas)
            {
                ...
                Point[] lineaRecortada = algoritmo.DibujarLineaCohen(
                ...
                {
                    // Verificar si la línea está completamente fuera
                    if (lineaRecortada[0] == lineaRecortada[1])
                    {
        ...
        private void FrmCohenSutherland_Paint(object sender, PaintEventArgs e)
        {
            RedibujarTodo();
        }
    }
