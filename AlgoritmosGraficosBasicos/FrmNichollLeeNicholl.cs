...
{
    public partial class FrmNichollLeeNicholl : Form
    {
        private static FrmNichollLeeNicholl _instance;
        private AlgoritmoNichollLeeNicholl algoritmo = new AlgoritmoNichollLeeNicholl();
        ...
        public static FrmNichollLeeNicholl Instance
        {
            get
            {
                if (_instance == null || _instance.IsDisposed)
                {
                    _instance = new FrmNichollLeeNicholl();
                }
                return _instance;
            }
        }

        public FrmNichollLeeNicholl()
        {
            InitializeComponent();
        }
        ...
        private void btnCalcular_Click(object sender, EventArgs e)
        {
            ...
            foreach (var linea in lineasDibujadas)
            {
                // Aplicar algoritmo Nicholl-Lee-Nicholl
        ...
        private void FrmNichollLeeNicholl_Load(object sender, EventArgs e)
        {
        ...
        private void FrmNichollLeeNicholl_Paint(object sender, PaintEventArgs e)
        {
            RedibujarTodo();
        }
    }
