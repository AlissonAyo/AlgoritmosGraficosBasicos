...
namespace Ayo_Alisson_Algoritmos
{
    ...
    {
        private static FrmCyrusBeck _instance;
        private AlgoritmoCyrusBeck algoritmo = new AlgoritmoCyrusBeck();
        ...
        public static FrmCyrusBeck Instance
        {
            get
            {
                if (_instance == null || _instance.IsDisposed)
                {
                    _instance = new FrmCyrusBeck();
                }
                return _instance;
            }
        }
        ...
        {
            InitializeComponent();
            this.FormClosing += FrmCyrusBeck_FormClosing;
        }

        private void FrmCyrusBeck_FormClosing(object sender, FormClosingEventArgs e)
        {
            LiberarRecursos();
        }
        ...
        {
            this.Text = "Algoritmo Cyrus-Beck - Recorte de Polígonos";
            lblResultado.Text = "";
            DibujarRectanguloRecorte();
        }

        private void FrmCyrusBeck_Paint(object sender, PaintEventArgs e)
        {
            RedibujarTodo();
        }
    }
