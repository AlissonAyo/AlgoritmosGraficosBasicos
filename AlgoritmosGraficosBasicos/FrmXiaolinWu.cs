...
{
    public partial class FrmXiaolinWu : Form
    {
        private static FrmXiaolinWu _instance;
        Graphics g;
        Pen pen = new Pen(Color.Black, 2);
        DibujarLinea objdibujarLinea;

        public static FrmXiaolinWu Instance
        {
            get
            {
                if (_instance == null || _instance.IsDisposed)
                {
                    _instance = new FrmXiaolinWu();
                }
                return _instance;
            }
        }
        ...
        private void btnCalcularLinea_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Crear instancia del algoritmo de Xiaolin Wu
                objdibujarLinea = new AlgoritmoXiaolinWu();
